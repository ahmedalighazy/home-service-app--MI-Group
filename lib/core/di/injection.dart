...
Future<void> setupGetIt() async {
  // Initialize all @injectable / @lazySingleton / @singleton registrations
  ...
  // AuthCubit is registered as factory by generated code — we need singleton.
  // Unregister the factory and re-register as lazySingleton.
  ...
  // Register ForgetPasswordCubit as factory (new instance per screen)
  ...
  try {
    ...
    // Already registered via init()
  }

  // Register LanguageCubit as singleton
