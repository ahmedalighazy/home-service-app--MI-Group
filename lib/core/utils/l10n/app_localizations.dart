...
abstract class AppLocalizations {
  ...
  /// No description provided for @resendCodePromptAlt.
  ///
  /// In ar, this message translates to:
  /// **'لم تتلقى الكود بعد ؟ '**
  String get resendCodePromptAlt;
  ...
  /// No description provided for @editNewPassDescription.
  ///
  /// In ar, this message translates to:
  /// **'أنشئ كلمة مرور جديدة، وتأكد من أنها مختلفة عن كلمه المرور السابقة '**
  String get editNewPassDescription;
  ...
  /// No description provided for @addAddressBtn.
  ///
  /// In ar, this message translates to:
  /// **'اضافة عنوان'**
  String get addAddressBtn;
  ...
  /// No description provided for @savedAddressesHeader.
  ///
  /// In ar, this message translates to:
  /// **'العناوين'**
  String get savedAddressesHeader;
  ...
  /// No description provided for @addYourAddress.
  ///
  /// In ar, this message translates to:
  /// **'إضافة عنوان جديد'**
  ...
  /// No description provided for @notSureFreeInspection.
  ///
  /// In ar, this message translates to:
  /// **'لست متأكداً احصل على معاينة مجانية'**
  String get notSureFreeInspection;
  ...
  /// No description provided for @bookdesc.
  ///
  /// In ar, this message translates to:
  ...
  /// No description provided for @confirmReschedule2.
  ///
  /// In ar, this message translates to:
  /// **'تأكيد  اعادة الجدولة'**
  String get confirmReschedule2;
  ...
  /// No description provided for @notFindbooking.
  ///
  /// In ar, this message translates to:
  /// **' لا توجد حجوزات قادمة'**
  String get notFindbooking;
  ...
  /// No description provided for @dettailsbooking.
  ///
  /// In ar, this message translates to:
  /// **'  تفاصيل الحجز'**
  String get dettailsbooking;
  ...
  ///
  /// In ar, this message translates to:
  /// **'ادخل الاسم كما هوا علي البطاقة'**
  ...
  /// No description provided for @payAfterServiceDesc.
  ///
  /// In ar, this message translates to:
  /// **'ادفع نقداً بعد اتمام الخدمة'**
  String get payAfterServiceDesc;
  ...
  /// No description provided for @serviceCompletedScreenTitle.
  ///
  /// In ar, this message translates to:
  /// **'اكتملت الخدمة'**
  String get serviceCompletedScreenTitle;
  ...
  /// No description provided for @expiryDateLabelTitle.
  ///
  /// In ar, this message translates to:
  /// **'ميعاد الانتهاء'**
  String get expiryDateLabelTitle;
