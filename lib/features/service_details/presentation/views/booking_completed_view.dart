...
class BookingCompletedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BookingFlowScaffold(
      title: SdStrings.completedService,
      child: Column(
        children: [
          ...
          Text(
            SdStrings.donePerformedCleaningDeepYourHomeSuccessfullyWeHope,
          ...
          BookingActionButton(
            label: SdStrings.rateExperience,
            isPrimary: false,
            onPressed: () {
