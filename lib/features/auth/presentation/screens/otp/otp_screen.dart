              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: _logic.canResend
                                  ? () => _logic.onResend(context)
                                  : null,
                              child: Text(
                                context.tr('resendCodeLink'),
                                style: TextStyle(
                                  color: _logic.canResend
                                      ? AppColors.greenPrimary
                                      : AppColors.placeholder,
                                  fontSize: 13.sp,
                                  fontWeight: FontWeight.bold,
                                  decoration: _logic.canResend
                ...
                Positioned(
                  ...
                  child: OtpConfirmButton(
                    ...
                    isEnabled:
                        _digits.length == _length &&
                        _logic.fieldState != OtpFieldState.error,
                    onPressed: _digits.length == _length
                        ? () => _logic.onConfirm(context)
                        : () {},
                  ),
                ),
                Positioned(
