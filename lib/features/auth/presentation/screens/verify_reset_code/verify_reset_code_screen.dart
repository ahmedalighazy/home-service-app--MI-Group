...
import 'widgets/verify_reset_code_hidden_input.dart';
                  ...
                  children: [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () => cubit.controllers.resetFocusNode.requestFocus(),
                              child: AnimatedBuilder(
                                ...
                                builder: (context, _) => OtpInputRow(
                                  ...
                                  shakeAnimation: cubit.uiState.resetAnimation.shakeAnim,
                                  onTap: () => cubit.controllers.resetFocusNode.requestFocus(),
                                ),
                              ),
                            ),
                            ...
                            if (cubit.uiState.resetFieldState == OtpFieldState.error)
                              Padding(
                                ...
                                child: Text(
                                  LocalizationService.instance.translate('otpCodeError'),
                    ...
                    Padding(
                      ...
                      child: OtpConfirmButton(
                        ...
                        isLoading: isLoading,
                        isSuccess: cubit.uiState.resetFieldState == OtpFieldState.success,
                        onPressed: cubit.resetCodeCtrl.text.length == length ? () {
                          cubit.controllers.resetFocusNode.unfocus();
                          cubit.verifyResetCode(email, cubit.resetCodeCtrl.text);
                        } : () {},
